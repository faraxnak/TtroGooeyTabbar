...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "$BUILT_PRODUCTS_DIR/PayWandBasicElements/PayWandBasicElements.framework"
  ...
  install_framework "$BUILT_PRODUCTS_DIR/TtroGooeyTabbar/TtroGooeyTabbar.framework"
